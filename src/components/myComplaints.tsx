        ...
        <div id="content">
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container-fluid">
                    ...
                    <button type="button" id="sidebarCollapse" onClick={handleSidebarToggle} className="btn btn-info">
            ...
            <div className="mb-2 fixedMenuFix ">
                ...
                <form>
                    ...
                    <button className="btn btn-primary btn-teal btn-sm"  onClick={onUploadFile}><span>Post</span></button>
                </form>
            </div>
            <div className="mb-2 fixedMenuFix">
                    ...
                    <div className="col-lg-12">
                        <div className="card">
                            <div className="d-flex p-2 px-3 justify-content-between">
                                ...
                                <div className="">
                                    <button type="submit" className="form-control btn btn-primary btn-teal rounded-pill submit px-3">Resolve Complaint</button>
                                </div>
                            </div>
                            <div className="p-2">
